...
std::tuple<runtime::train_state,increase_time::train_drive> get_end_state(runtime::train_state current_state,soro::train_path_envelope::tpe_point const& pt, runtime::interval& interval,
